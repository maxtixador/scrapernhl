"""
OHL Additional Wrapper Functions

Additional wrapper functions for OHL data that provide convenience aliases
...
from scrapernhl.ohl.api import (
    get_scorebar, get_play_by_play, get_game_summary, OHLConfig, fetch_api
)
...
def scrapeScorebar(
    ...
    # OHL scorebar returns data directly in 'Scorebar' key (no SiteKit wrapper)
...
def scrapeSkaterStats(
    ...
    from .stats import scrapePlayerStats
