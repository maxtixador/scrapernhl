"""
AHL Scraper Functions

Wrapper functions that convert AHL API responses to pandas DataFrames.
...
from scrapernhl.ahl.api import (
    ...
    get_play_by_play, get_game_summary, AHLConfig
)


def scrapeTeams(season: Union[int, str] = None, config: AHLConfig = None) -> pd.DataFrame:
    """
    Scrape AHL teams data as a DataFrame.
...
def scrapeSchedule(
    ...
    """
    Scrape AHL schedule as a DataFrame.
...
def scrapeStandings(
    ...
    """
    Scrape AHL standings as a DataFrame.
...
def scrapeRoster(
    ...
    """
    Scrape AHL team roster as a DataFrame.
